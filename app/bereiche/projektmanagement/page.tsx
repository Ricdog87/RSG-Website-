...
import { ArrowLeft, Calendar, Kanban, Target, Clock, Users, Layers } from "lucide-react"
  ...
  const pmServices = [
    {
      ...
      title: "Strategische Projektleiter-Vermittlung",
      description: "Maßgeschneiderte Vermittlung von erfahrenen Projektmanagern mit branchenspezifischer Expertise.",
    },
    {
      icon: <Clock className="h-8 w-8 text-cyan-400" />,
      title: "Interim Projektmanagement",
      description: "Kurzfristige Bereitstellung von hochqualifizierten Projektmanagern für zeitkritische Vorhaben.",
    },
    {
      icon: <Users className="h-8 w-8 text-cyan-400" />,
      title: "Projektteam-Aufbau",
      description: "Zusammenstellung kompletter Projektteams mit allen erforderlichen Kompetenzen für Ihr Vorhaben.",
    },
    {
      icon: <Layers className="h-8 w-8 text-cyan-400" />,
      title: "PM-Methodenkompetenz",
      description: "Vermittlung von Experten mit spezifischen Methodenkompetenzen (Agile, Scrum, PRINCE2, PMI).",
    },
  ]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div ref={contentRef} className="space-y-6 text-white/80">
              <p className="text-lg">
                Erfolgreiche Projekte brauchen exzellente Führung. Wir verbinden Unternehmen mit den besten
                Projektmanagement-Talenten, die komplexe Vorhaben sicher zum Erfolg führen.
              </p>
              ...
              <div className="relative">
                ...
                <div className="relative bg-black/60 backdrop-blur-sm p-6 rounded-lg border border-white/10">
                  <div className="flex items-start gap-4">
                    <Kanban className="h-8 w-8 text-cyan-400 mt-1" />
                    <div>
                      <h3 className="text-xl font-semibold mb-2 text-white">Unser PM-Matching</h3>
                      <p>
                        Wir analysieren nicht nur methodische Kompetenzen, sondern auch Führungsstil, Branchenerfahrung
                        und kulturelle Passung, um die ideale Übereinstimmung zwischen Projektmanagern und
                        Unternehmensanforderungen zu gewährleisten.
                      </p>
                    </div>
                  </div>
                </div>
