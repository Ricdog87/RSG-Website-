...
import { ArrowLeft, Calendar, Code, Server, Database, Shield } from "lucide-react"
  ...
  const itServices = [
    {
      ...
      title: "Entwickler-Vermittlung",
      description:
        "Maßgeschneiderte Vermittlung von hochqualifizierten Entwicklern mit spezifischen Technologie-Stacks.",
    },
    {
      icon: <Server className="h-8 w-8 text-cyan-400" />,
      title: "IT-Infrastruktur-Experten",
      description: "Vermittlung von Spezialisten für den Aufbau und die Wartung moderner IT-Infrastrukturen.",
    },
    {
      icon: <Database className="h-8 w-8 text-cyan-400" />,
      title: "Datenbank & Analytics",
      description: "Experten für Datenbanken, Big Data und Business Intelligence für datengetriebene Entscheidungen.",
    },
    {
      icon: <Shield className="h-8 w-8 text-cyan-400" />,
      title: "Cybersecurity-Talente",
      description:
        "Sicherheitsexperten zum Schutz Ihrer digitalen Assets und zur Implementierung robuster Sicherheitskonzepte.",
    },
  ]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div ref={contentRef} className="space-y-6 text-white/80">
              <p className="text-lg">
                Digitale Transformation erfordert erstklassige IT-Expertise. Wir verbinden Unternehmen mit den besten
                IT-Spezialisten, die innovative Lösungen entwickeln und implementieren.
              </p>
              ...
              <div className="relative">
                ...
                <div className="relative bg-black/60 backdrop-blur-sm p-6 rounded-lg border border-white/10">
                  <div className="flex items-start gap-4">
                    <Code className="h-8 w-8 text-cyan-400 mt-1" />
                    <div>
                      <h3 className="text-xl font-semibold mb-2 text-white">Unser IT-Matching</h3>
                      <p>
                        Wir analysieren nicht nur technische Fähigkeiten, sondern auch Problemlösungskompetenz,
                        Teamfähigkeit und kulturelle Passung, um die ideale Übereinstimmung zwischen IT-Spezialisten und
